...
#from flask_gravatar import Gravatar # I will need a workaround for this
import hashlib # For gravatar workaround
...
def register():
    ...
    if form.validate_on_submit():
        ...
        existing_user = db.session.execute(db.select(User).filter_by(email=form.email.data)).scalar()
        if existing_user:
